 ...
 * on 2015-11-25 at 06:09:22 UTC 
 * Modify at your own risk.
 */

package com.example.eric.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Joke joke(java.lang.Integer num) throws java.io.IOException {
    Joke result = new Joke(num);
    initialize(result);
    return result;
  }

  public class Joke extends MyApiRequest<com.example.eric.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "joke/{num}";
     ...
     * @since 1.13
     */
    protected Joke(java.lang.Integer num) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.eric.myapplication.backend.myApi.model.MyBean.class);
      this.num = com.google.api.client.util.Preconditions.checkNotNull(num, "Required parameter num must be specified.");
    }
    ...
    public Joke setNum(java.lang.Integer num) {
      this.num = num;
      return this;
    }
  ...
  public class SayHi extends MyApiRequest<com.example.eric.myapplication.backend.myApi.model.MyBean> {
